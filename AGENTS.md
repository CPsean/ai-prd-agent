...
| 元数据 | 值 |
|--------|-----|
| 基于 template 版本 | v5.4（2026-04-25） |
| 基于 template 提交 | `ae685f8` |
| 同步日期 | 2026-04-25 |
| 同步内容摘要 | F-010 PRD模板格式优化：新增§5.3核心业务规则（BR-XX）与§10验收检查清单（checkbox），关联文件§编号同步 |
